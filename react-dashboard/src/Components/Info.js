...
class MyCard extends React.Component {
  acceptData = (email, contact, distributed_index, distributed_to) => {
  ...
  render() {
    const { classes, name, index, email, contact, imgURL, item } = this.props;
    return (
      <div
        style={{
          margin: "10px"
            ...
            <Grid container>
              <Grid item xs={4} sm={4}>
                <Button
                  ...
                  onClick={() => this.acceptData(email, contact, index, name)}
                >
                  Accept
                </Button>
              </Grid>
